<?php
if (!class_exists('learningAppWalker')) {
	class learningAppWalker extends Walker_Nav_Menu
	{
		...
		public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) 
		{
			...
			$attributes .= (is_object($args) && $args->has_children) ? ' class="dropdown-toggle ripple" data-toggle="dropdown" aria-expanded="false"' : '';

			$item_output = (is_object($args)) ? $args->before : '';
			$item_output .= '<a' . $attributes . '>';
			$item_output .= (is_object($args) && $args->has_children) ? '<span class="ink animate"></span>' : '';
